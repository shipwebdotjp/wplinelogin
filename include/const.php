			...
			'other' => array(
				...
				'fields' => array(
					...
					'unlink_autocreated_account' => array(
						...
						'required' => true,
						'list' => array('on' => __('Just unlink , remain account', linelogin::PLUGIN_NAME), 'delete' => __('Delete Account', linelogin::PLUGIN_NAME), 'off' => __('Disable unlinking', linelogin::PLUGIN_NAME)),
						'default' => 'off',
